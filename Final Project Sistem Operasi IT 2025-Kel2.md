...
Buat program dimana ketika Ctrl+C (SIGINT), Ctrl+Z (SIGSTP), atau kill (SIGKILL) akan menunjukkan pesan khusus untuk demonstrasi cara kerja signal, tambahkan demonstrasi SIGNAL sebanyak mungkin.
### Catatan
